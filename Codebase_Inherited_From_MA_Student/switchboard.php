										...
										else
										{
                        					...
                        					<?php
												...
												if ($role=="Administrator")
                        						{
													...
													echo	"<tr>";
													echo		"<td width='100%' align='center'>";
													echo		"<form  action='newprofile.php' method='post' name='profilemanagement'>";													
													echo			"<input id='btnLogin' type='submit' value='Your Profile Update' style='width:40%;font-weight:bold;height:35px;COLOR:#4682B4'/>";
													echo		"</form>";								
													echo		"</td>";																										
													echo	"</tr>";													
													...
													echo		"<td width='100%' align='center'>";
													echo		"<form  action='AdvancedQuery.php' method='post' name='index'>";													
													echo			"<input id='btnLogin' type='submit' value='Advance Search' style='width:40%;font-weight:bold;height:35px;COLOR:#4682B4'/>";
													echo		"</form>";		
													echo		"</td>";																										
													echo	"</tr>";
													echo	"<tr>";
