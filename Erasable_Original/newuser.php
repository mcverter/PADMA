  ...
  <table cellpadding="0" cellspacing="0" width="80%" align="center" bgcolor="#F0FFF0">
	...
	<fieldset>
	  ...
	  <table cellpadding="0" cellspacing="0" width="100%" align="center" bgcolor="#F0FFF0">
	    <tr>
	      <td width="100%" valign="top" style="font-family:Verdana;" align="left"><font color="#4682B4"><h2>NEW USER</h2></font><br /><font color="#4682B4"><h5>Welcome to PADMA Database. Just select an UserID and Password, answer a few simple questions. We will <u>send you a e-mail</u> when your account setup is complete</h5></font><hr noshade height=1px style="border:dotted;color:gray" />
	      </td>
	    </tr>
	    <tr><td>&nbsp;</td></tr>		  
	    <tr>
	      <td><b><font color="#4682B4">1. Select a non-existing User ID</font></b>
	      <table cellpadding="2" cellspacing="2" width="100%" style="font-family:Verdana; font-size:small" align="right">
		<tr><td>&nbsp;</td></tr>
		<tr>
		  <td align="right" width="30%">User ID:<font color="red">*</font>&nbsp;&nbsp;</td>
	...
	<form name="form1" action="newuserSubmit.php" method="post" onsubmit="return validate(form1);">
	  <table cellpadding="0" cellspacing="0" width="100%" align="center" bgcolor="#F0FFF0">
	    <tr><td>&nbsp;</td></tr>
	    <tr><td><font color="#4682B4"><b>2. Select your initial password</b></font>
			...
			<td>
			  <table cellpadding="0" cellspacing="0" width="100%">
				...
				<table table cellpadding="2" cellspacing="2" width="100%" style="font-family:Verdana; font-size:small" align="right">
				  <tr>
				    <td align="right" width="30%">Password:<font color="red">*</font>&nbsp;&nbsp;</td>
				    <td width="40%" align="left"><input name="password" type="password" style="width:90%" /></td>
				    <td width="30%" align="left">&nbsp;&nbsp;</td>
				  </tr>
				  <tr>
				    <td align="right" width="30%">Re-Type Password:<font color="red">*</font>&nbsp;&nbsp;</td>
				    <td width="40%" align="left"><input name="password2" type="password" style="width:90%" /></td>
				    <td width="30%" align="left">&nbsp;&nbsp;</td>
				  </tr>
				      </table>
       			      </td>
	    ...
	    <tr><td>&nbsp;</td></tr>
	    <tr><td width="100%" valign="top" style="font-family:Verdana; font-size:medium" align="left">
	        <b><font color="#4682B4">3. Please tell us about you</font></b><p></p>
