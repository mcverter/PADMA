...
<tr><td class="_T">>Comments</td><td><textarea name="comments" rows="6" cols="30"></textarea></td></tr>
...
$message = $message . PHP_EOL.PHP_EOL."-- ".PHP_EOL."Thank you for visiting http://padmadatabase.org";

$message = stripslashes($message);

$subject = "PADMA User Contact!";
...
<html>
  ...
  <body bgcolor="#F0F8FF" text="#000000">
	...
	<p><a href="<?php print $continue; ?>">Back to Contact Page</a></p>
      </center>
    </div>
